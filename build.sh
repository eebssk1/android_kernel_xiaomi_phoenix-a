...
curl -L "https://github.com/eebssk1/arm-gcc/releases/download/a942717a/arm-gcc.tgz" | tar -zxf -

export PATH=${PWD}/arm-gcc/aarch64-linux-musl/bin:${PWD}/arm-gcc/arm-linux-musleabihf/bin:$PATH
